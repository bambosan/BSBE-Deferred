$input v_texcoord0, v_color0, v_light, v_fog, v_glintUV, v_normal, v_worldPos
...
SAMPLER2DARRAYSHADOW(s_ShadowCascades0, 5);
SAMPLER2DARRAYSHADOW(s_ShadowCascades1, 7);
BUFFER_RO(s_DirectionalLightSources, LightSourceWorldInfo, 6);
